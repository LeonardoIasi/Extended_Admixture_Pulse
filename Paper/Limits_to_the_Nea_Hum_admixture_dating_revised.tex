...
Both for the ALD and segments we use simplistic models that ignore the effects of genetic drift and recombination between introgressed segments. In the appendix section \ref{Appendix_1}, we discuss these approximations and show that their impact is small in the parameter range of interest.
