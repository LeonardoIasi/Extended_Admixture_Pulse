...
#Real_fit_Result_norm <- Real_fit_Result_norm[Real_fit_Result_norm$Duration==1e5,]
...
New.P3_mean_GF_exp <- Plot_sampling_varying_gen_t_GF(ggdata_t.GF_varying_mean_GF_exp,cbPalette_viridis,"All admixture durations = 800 gen exponential fit")
New.P3_mean_GF_lomax <- Plot_sampling_varying_gen_t_GF(ggdata_t.GF_varying_mean_GF_lomax,cbPalette_viridis,"All admixture durations  = 800 gen lomax fit")
