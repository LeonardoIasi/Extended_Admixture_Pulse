...
<!-- [could be expanded, e.g. referring to other systems where people look at admixture] -->
<!-- speciation and hibridazation review [@abbott_hybridization_2013] -->
<!-- chimp bonobo admixture [@manuel_chimpanzee_2016] -->

*bp:this feels very thin. It's OK to motivate admixture as something that is widely
present, but then you need to give a comprehensive introduction, not just a very
incomplete list of papers. The alternative is to simply refer to a bunch of
relevant reviews*

<!-- , such as an ancient admixture event in the primate lineage between chimpanzees and bonobos [@manuel_chimpanzee_2016]. -->
...
<!-- *add hellenthal 2014 science* -->
<!-- [add more papers].  -->

*Maybe introduce here the term of admixture pulse*
...
<!-- *This paragraph is in quite good shape, but I think it is worth highlighting how -->
<!-- the approaches used differ, and why accuracy was increased over time* -->
...
*this should be at the end of the intro*
##What we want to do
...
*this should go in the discussion*
...
<!-- Tract ength can be correlated due to the variance in migrant ancestors an individual has and due to inbreeding bringing together migrant joining together migrant tracts -->

<!-- *in this paragraph, you repeated yourself a lot. Try to be concise and present -->
<!-- your argument in one logical sequence whenever possible* -->
...
biased 
*recap what Priya/Sriram found about the bias/correction*. 
...
### Demography
*this section (and frequently your writing in general) could need more structure. 
One simple approach is the _context-content-conclusion_ system (
https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619)
For this intro section, the basic idea is that for each paragraph you need to 
make clear that you start by*
...
*explain briefly why this is necessary, and how exactly this is done*
...
<!-- What to cite for the last sentence?? -->
...
the start and end, hence the duration of admixture between Neandertals and non-African populations. *preceeding section could be merged with last intro paragraph*
