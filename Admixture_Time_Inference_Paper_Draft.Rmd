...
As recombination breaks the introgressed chromosomal segments apart each generation, the association between variants on these introgressed segments decays as genetic distance increases. A pairwise LD between introgressed variants is calculated, using an ascerteinment scheme to filter for the introgressed variants in the admixed population[@sankararaman_date_2012]. The pairwise LD as a function of genetic distant is then fitted using an exponential distribution holding a point estimate for the time since the admixture event [@moorjani_history_2011][@loh_inferring_2013]. 
<!-- R Chakraborty and K M Weiss for the idea of using LD -->
<!-- Ascertainment scheme only nescessary for old admixture when non_ALD and ALD are both short (for recent admixture ALD is strong enough such that non-ALD is negligible) -->
...
<!-- add more problems: -->
<!-- how are recombination maps obtained LD , decode pedigree, different in pops and in time -->
