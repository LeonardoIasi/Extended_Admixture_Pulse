...
Both approaches, the direct measure of the segment length and the indirect ALD based method, without first directly inferring introgressed segments such as the popular ALDER program [@loh_inferring_2013], typically require fairly strong assumptions [@pool_inference_2009; @gravel_population_2012; @liang_lengths_2014].
