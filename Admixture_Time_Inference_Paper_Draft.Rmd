...
```{r fig3,message=FALSE, echo=FALSE,warning=FALSE,fig3.pos="H",fig.width=9,fig.height=8,fig.cap="\\label{fig:fig3} Comparison between the effect sizes of the estimated parameters on the standardized difference between true and estimated admixture time"}
...
ggplot(Post_effect_size_est,aes(x=row.names(Post_effect_size_est),y=as.numeric(as.character(mean))))+
  ...
  scale_x_discrete(labels= c("Standard Model","Continuous GF","Varying recombination","Complex Demography","d0 = 0.02","HES")
                    )+
  scale_color_manual("Gene Flow Model",
