...
<!-- [present this a sentence or two earlier]. -->
...
### Demography
A thirs issue are assumptions about the demography. 
<!-- [explain how demography would bias gene flow estimates]  -->
...
Uncertainties in the recombination map were priviously shown to bias admixture time etimates.
...
Having established that the duration of continuous admixture under ideal circumstances is only marginally influencial on admixture time estimates, we deploi more realistic simulation scenarios.
