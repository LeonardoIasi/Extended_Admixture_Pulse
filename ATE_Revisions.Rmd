...
Sim_2_ggplot_all <- data.frame(LRT=c(Sim_2_ggplot_all$V1,Sim_2_ggplot_all$V5),tm_SP_est=c(Sim_2_ggplot_all$V2,Sim_2_ggplot_all$V6),tm_EP_est=c(Sim_2_ggplot_all$V3,Sim_2_ggplot_all$V7),k_EP_est=c(Sim_2_ggplot_all$V4,Sim_2_ggplot_all$V8),n_seg=rep(c(rep(100,100),rep(1000,100),rep(10000,100),rep(100000,100)),2),
tm_true=c(Sim_2_ggplot_all$V9,Sim_2_ggplot_all$V11),td_true=c(Sim_2_ggplot_all$V10,Sim_2_ggplot_all$V10))
Sim_2_ggplot_all$Sampling <- ifelse(Sim_2_ggplot_all$tm_true!=1500,"sampling_50_gen_after_gf","sampling_at_0")
...
Plot_power_analysis <- function(Data,Sim_2_ggplot_all_sig_cutoff,Colour_P){
  Px <-  ggplot(Data,aes(x=as.factor(Sampling),y=LRT,color=as.factor(Sampling)))+
    geom_boxplot()+
    facet_grid(n_seg~td_true,switch = "x",labeller=labeller(.rows=c("100"="# fragments: 100","1000"="# fragments: 1000", "10000"="# fragments: 10000", "1e+05"="# fragments: 100000")))+
...
Plot_power_analysis_error <- function(Data,Colour_P){
  ...
  Px <-  ggplot(Data,aes(x=as.factor(Est_name),y=Est_error,color=as.factor(Est_name)))+
    ...
    labs(y = "RMSE")+
    scale_color_manual("",
                       values = c(Colour_P[1:6]),
                       labels = c("SP tm sampled at present","SP tm Sampled 50 after end of gene flow",
                                  "EP tm sampled at present","EP tm Sampled 50 after end of gene flow",
                                  "EP td sampled at present","EP td Sampled 50 after end of gene flow"))
  return(Px)
  
}

Plot_power_analysis_error(Error_plot_red,cbPalette_viridis)

```

```{r figR1_error_ests_corrected,message=FALSE, echo=FALSE,warning=FALSE,fig1.pos="H",fig.width=7,fig.height=4,fig.cap="\\label{fig:figR1_error_ests_corrected} Liklihood ratios between the simple pulse and extended pulse model for different durations of admixture for 100, 1000, 10000 and 100000 segments sampled at time 0 and 50 generations after the end of admixture. Boxplots from 100 replications."}
...
Plot_power_analysis_error_corrected(Error_plot_red,cbPalette_viridis)
```
...
```{r eval=T,figResult3_2, message=FALSE, echo=FALSE,warning=FALSE,figR3_3.pos="H",fig.width=7,fig.height=4,fig.cap="\\label{fig:figResult3_2} Fit to data Segments, ALD constant;constant, HapMap;HapMap"}
...
```{r eval=F,figResult3_2_alt1, message=FALSE, echo=FALSE,warning=FALSE,figR3_3.pos="H",fig.width=7,fig.height=9,fig.cap="\\label{fig:figResult3_2_alt1} Fit to data Segments, ALD constant;constant, HapMap;HapMap"}
# Alternative
...
```{r eval=T,figResult3_2_Supplements, message=FALSE, echo=FALSE,warning=FALSE,figR3_3.pos="H",fig.width=7,fig.height=4,fig.cap="\\label{fig:figResult3_2_Supplements} Fit to data Segments, ALD HapMap;constant, HapMap;AAMap"}
...
```{r eval=F,figResult3_2_alt2, message=FALSE, echo=FALSE,warning=FALSE,figR3_3.pos="H",fig.width=7,fig.height=9,fig.cap="\\label{fig:figResult3_2_alt2} Fit to data Segments, ALD constant;constant, HapMap;HapMap"}
...
```{r eval=F,figResult3_2_Supplements_alt, message=FALSE, echo=FALSE,warning=FALSE,figR3_3.pos="H",fig.width=7,fig.height=9,fig.cap="\\label{fig:figResult3_2_Supplements_alt} Fit to data Segments, ALD HapMap;constant, HapMap;AAMap"}
...
```{r eval=T,figResult3_3, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=7,fig.height=7,fig.cap="\\label{fig:figResult3_3} "}
...
```{r eval=T,figResult3_3_supplements, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=7,fig.height=7,fig.cap="\\label{fig:figResult3_3_supplements} "}
