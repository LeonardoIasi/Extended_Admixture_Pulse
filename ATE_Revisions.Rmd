...
plot_ALD_fit <- function(input,lval=0.05,hval=0.8,tm,td,use_log=F,main){
  tm=tm
  td=td
  k=1/((td/(4*tm))^2)
  # Fitting functions
  ...
  Fit_Results <- data.frame(x=data_x$M,y=(SP_tail_log(data_x$M,c(tm,coef(Fit_SP)[2]))),fit="SP_true")
