...
Sim_2_ggplot_100 <- data.frame(l_LRT=melt(Sim_2[[1]])[3],t_sample=melt(Sim_2[[1]])[2],n_seg=100,td=as.factor(rep(t_d,each=200)))
Sim_2_ggplot_1000 <- data.frame(l_LRT=melt(Sim_2[[2]])[3],t_sample=melt(Sim_2[[2]])[2],n_seg=1000,td=as.factor(rep(t_d,each=200)))
Sim_2_ggplot_10000 <- data.frame(l_LRT=melt(Sim_2[[3]])[3],t_sample=melt(Sim_2[[3]])[2],n_seg=10000,td=as.factor(rep(t_d,each=200)))
Sim_2_ggplot_100000 <- data.frame(l_LRT=melt(Sim_2[[4]])[3],t_sample=melt(Sim_2[[4]])[2],n_seg=100000,td=as.factor(rep(t_d,each=200)))
...
``` {r figR3_3, message=FALSE, echo=FALSE,warning=FALSE,figR3_3.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR3_3} Neandertal duration simple and extended pulse AIC and F test comparison"}


AIC_comp=data.frame(AIC_SP=Plot.data_Nea_tm$AIC_SP,
...
``` {r figR3_4, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR3_4} "}
...
``` {r figR3_5, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR3_4} "}
...
Direct_segments_LRT <- ggarrange(True_LRT,Inferred_LRT,labels = c("A","B"),
          ncol = 2, nrow = 1,widths = c(0.5,0.5),common.legend = T,legend = 'bottom')
Direct_segments_LRT
```
...
Fig_2_3 <- Read_GLM_indata("/mnt/diversity/leonardo_iasi/Adm_Time_Dating_Sim/Paper_Revisions/Fig_2_C_corrected_revision/Result_classic_Exp/")
...
Fig_2_4 <- Read_GLM_indata("/mnt/diversity/leonardo_iasi/Adm_Time_Dating_Sim/Paper_Revisions/Fig_2_D_Complex_corrected_revision/Result_classic_Exp/")
