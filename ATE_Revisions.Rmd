...
Sim_2_ggplot_all$tm_SP_est_error_norm <- (Sim_2_ggplot_all$tm_true-Sim_2_ggplot_all$tm_SP_est)/sd(Sim_2_ggplot_all$tm_SP_est)
Sim_2_ggplot_all$tm_EP_est_error <- sqrt((Sim_2_ggplot_all$tm_true-Sim_2_ggplot_all$tm_EP_est)^2)
Sim_2_ggplot_all$tm_EP_est_error_norm <- (Sim_2_ggplot_all$tm_true-Sim_2_ggplot_all$tm_EP_est)/sd(Sim_2_ggplot_all$tm_EP_est)
Sim_2_ggplot_all$k_EP_est_error <- sqrt((Sim_2_ggplot_all$k_true -Sim_2_ggplot_all$k_EP_est)^2)
Sim_2_ggplot_all$k_EP_est_error_norm <- (Sim_2_ggplot_all$k_true-Sim_2_ggplot_all$k_EP_est)/sd(Sim_2_ggplot_all$k_EP_est)
...
Error_plot <- data.frame(Est_error=c(Sim_2_ggplot_all$tm_SP_est_error,Sim_2_ggplot_all$tm_EP_est_error,Sim_2_ggplot_all$k_EP_est_error ),
                         ...
                         Est_error_norm=c(Sim_2_ggplot_all$tm_SP_est_error_norm,Sim_2_ggplot_all$tm_EP_est_error_norm,Sim_2_ggplot_all$k_EP_est_error_norm ),
...
```{r eval=T,figR1_error_ests_norm,message=FALSE, echo=FALSE,warning=FALSE,fig1.pos="H",fig.width=7,fig.height=4,fig.cap="\\label{fig:figR1_error_ests_norm} Liklihood ratios between the simple pulse and extended pulse model for different durations of admixture for 100, 1000, 10000 and 100000 segments sampled at time 0 and 50 generations after the end of admixture. Boxplots from 100 replications."}




Plot_power_analysis_error_normalized <- function(Data,Colour_P){
    Data$Est_error_norm <- ifelse(Data$Est_error_norm>2,2,Data$Est_error_norm)
    Data$Est_name <- factor(Data$Est_name,
                        levels = c("sampling_at_0_SP_tm","sampling_at_0_EP_tm","sampling_at_0_EP_td","sampling_50_gen_after_gf_SP_tm"
                                   ,"sampling_50_gen_after_gf_EP_tm","sampling_50_gen_after_gf_EP_td"),ordered = TRUE)
...
Plot_power_analysis_error_normalized(Error_plot_red,viridis(15,option = "D"))
```
...
Plot_all_together_samples_50_gen_flipped <- function(ggdata,cbPalette_viridis){
  ...
  ggdata$Name <- factor(ggdata$Name,
                        levels = c("HapMap/HapMap","HapMap/AAMap","HapMap/Constant",
                                   "Constant/Constant"),ordered = TRUE)
  ggplot(data = ggdata, aes(y=factor(Name),x=as.numeric(as.character(value)),colour=factor(Name))) +
    ...
    scale_color_manual("Simulations",
                       values = c(cbPalette_viridis[12],cbPalette_viridis[9],cbPalette_viridis[3],cbPalette_viridis[1]),
...
Seg_ald_tm_results <- Plot_tm(ggdata_tm_results,"","Constant/Constant","HapMap/HapMap",cbPalette_viridis[1],cbPalette_viridis[12])
Seg_ald_td_results <- Plot_td(ggdata_td_results,"","Constant/Constant","HapMap/HapMap",cbPalette_viridis[1],cbPalette_viridis[12])
...
```{r eval=T,figResult2_2and3, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=7.5,fig.height=4,fig.cap="\\label{fig:figResult2_2and3} "}
...
```{r eval=T,figResult2_2and3_supplement, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=7.5,fig.height=4,fig.cap="\\label{fig:figResult2_2and3_supplement} "}
