...
RSS_comp=data.frame(RSS_diff=log(Plot.data_ALD_red$RSS_SP)-log(Plot.data_ALD_red$RSS_EP),
...
Inferred_segments <- Inferred_segments %>% filter(td!= 100 & td!= 200 & td!= 400 & td!= 800)
...
Plot_GLM_model_0 <- function(Model){
  ...
  HPDI(post_effect_size_model$a + post_effect_size_model$bd,0.95)[2])
  #,row.names = c("Standard Model","Continuous GF","Varying recombination","Complex Demography","d0 = 0.02","HES")
  )
  
  Post_effect_size_est_table <- Post_effect_size_est
  row.names(Post_effect_size_est_table) <- c("Standard Model","Continuous GF","Varying recombination","Complex Demography","d0 = 0.02","HES","downsampled")
  Post_effect_size_est_table$Variable <- factor(row.names(Post_effect_size_est_table),
                levels = c("Standard Model","Continuous GF","Varying recombination","Complex Demography","d0 = 0.02","HES","downsampled"),ordered = TRUE)
...
Plot_GLM_model_1 <- function(Model){
  ...
  Post_effect_size_est_table$Variable <- factor(row.names(Post_effect_size_est_table),
                  levels = c("Standard Model","Continuous GF","Varying recombination","Complex Demography","d0 = 0.02","HES","downsampled",
...
RSS_comp_50=data.frame(RSS_diff=log(Plot.data_50_complete$RSS_SP)-log(Plot.data_50_complete$RSS_EP),
                       RSS_diff_norm=unlist(RSS_diff_norm),
...
RSS_comp_varying=data.frame(RSS_diff=log(Plot.data_varying_complete$RSS_SP)-log(Plot.data_varying_complete$RSS_EP),
                           RSS_diff_norm= unlist(RSS_diff_norm),
