...
xdata.M.3.no_error$Diff_s <- (xdata.M.3.no_error$m.exp - xdata.M.3.no_error$True_tm)/sd(xdata.M.3.no_error$m.exp)
...
#Effect_size_fixed_s_2 <- rethinking::ulam(
#  alist(
#    E ~ dnorm(mu,sigma),
#    mu <- a + bA*A + bm*MD + bD*D + bR*R + bG*GF + bDS*DS,
#    a ~ dnorm( 0 , 2 ),
#    c(bA,bm,bD,bR,bG,bDS) ~ dnorm( 0 , 2 ),
#    sigma ~ dexp(1)
