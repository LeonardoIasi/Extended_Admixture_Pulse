...
#Result.Table.path_ALD_no_correction <-'/mnt/diversity/leonardo_iasi/Adm_Time_Dating_Sim/Paper_Revisions/Segment_ALD_comparison_recombination_map_ALD/Result_Simple_Extended_Pulse_linear_interpolation/Result_file_SIM_Raw_ALDER-Fit-Segment_ALD_comparison_recombination_map_ALD-GF_Model_IV-min_dist_Fit-0.05-ascertainmentI-downsampled100-ReccNo_correction.txt'
#Result.Table.path_ALD_AAMap_correction <-'/mnt/diversity/leonardo_iasi/Adm_Time_Dating_Sim/Paper_Revisions/Segment_ALD_comparison_recombination_map_ALD/Result_Simple_Extended_Pulse_linear_interpolation/Result_file_SIM_Raw_ALDER-Fit-Segment_ALD_comparison_recombination_map_ALD-GF_Model_IV-min_dist_Fit-0.05-ascertainmentI-downsampled100-ReccAAMap_correction.txt'
#Result.Table.path_ALD_HapMap_correction <-'/mnt/diversity/leonardo_iasi/Adm_Time_Dating_Sim/Paper_Revisions/Segment_ALD_comparison_recombination_map_ALD/Result_Simple_Extended_Pulse_linear_interpolation/Result_file_SIM_Raw_ALDER-Fit-Segment_ALD_comparison_recombination_map_ALD-GF_Model_IV-min_dist_Fit-0.05-ascertainmentI-downsampled100-ReccHapMap_correction.txt'
...
``` {r eval=T,fig_ALD_fit_visual, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:fig_ALD_fit_visual} "}
...
Extended_Pulse_fn <- function(Data,affine){
  xx=Data
  ...
  if(use_log==T) {
    ...
    fm2_lomax_k <- function(x) sum((wcorr-fm1_lomax(x))^2)
    fm3_DEoptim <- DEoptim(fm2_lomax_k, lower=c(0.5,4,1e-8), upper=c(5,9,exp(1)), control=list(trace=FALSE))
    
    par1_lomax <- fm3_DEoptim$optim$bestmem
    print(par1_lomax)
    par1_lomax <- c(par1_lomax[1],par1_lomax[2],par1_lomax[3])
    names(par1_lomax) <- c("k","tm","A")
    fit1_lomax <- nls(wcorr ~ log(A) + k* -log(1 + ((k/tm)*(dist/100))), start=par1_lomax, control=list(maxiter=100000, warnOnly=TRUE,minFactor=0.0004))
  }
...
plot_ALD_fit <- function(input,lval=0.05,hval=0.8,tm,td,main){
  tm=tm
  td=td
  k=1/((td/(4*tm))^2)
  # Fitting functions
  ...
  Fit_SP <- Simple_Pulse_fn(ALD_x,affine = T)
  
  Fit_EP <-  Extended_Pulse_fn(ALD_x,affine=T) 
  ...
  Fit_Results <- data.frame(x=data_x$M,y=(SP_tail_log(data_x$M,c(tm,coef(Fit_SP)[1]))),fit="SP_true")
  ...
  Fit_Results <- rbind(Fit_Results,data.frame(x=data_x$M,y=(EP_tail_log(data_x$M,c(tm,k,coef(Fit_EP)[3]))),fit="EP_true"))
  Fit_Results$fit <- factor(Fit_Results$fit,
                      levels = c("SP_true","SP_fit","EP_true","EP_fit"),ordered = TRUE)

  
  P_fit <- ggplot(data=Fit_Results,aes(x = x, y = y,color=fit,fill=fit))+
    geom_point(data=data_x,aes(x=M,y=ALD,fill=NULL),color="grey",show.legend = F)+
    geom_line(data=Fit_Results,aes(x = x, y = y,color=fit),size=1.2)+
...
ALD_const_td_1 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_ALD/Raw_ALDER_output-_Scenario_1_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccNo_correction.txt",tm = 1500,td = 1,main = "Constant;Constant")
ALD_var_const_td_1 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_1_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccNo_correction.txt",tm = 1500,td = 1,main = "HapMap;Constant")
ALD_var_AAMap_td_1 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_1_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccAAMap_correction.txt",tm = 1500,td = 1,main = "HapMap;AAMap")
ALD_var_HapMap_td_1 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_1_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccHapMap_correction.txt",tm = 1500,td = 1,main = "HapMap;HapMap")

ALD_td_1 <- ggarrange(ALD_const_td_1,ALD_var_const_td_1,ALD_var_AAMap_td_1,ALD_var_HapMap_td_1,labels = c("A","B","C","D"),
          ncol = 2, nrow = 2,common.legend = T,legend = 'bottom')

ALD_const_td_2000 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_ALD/Raw_ALDER_output-_Scenario_7_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccNo_correction.txt",tm = 1500,td = 2000,main = "Constant;Constant")
ALD_var_const_td_2000 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_7_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccNo_correction.txt",tm = 1500,td = 2000,main = "HapMap;Constant")
ALD_var_AAMap_td_2000 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_7_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccAAMap_correction.txt",tm = 1500,td = 2000,main = "HapMap;AAMap")
...
ALD_td_2000 <- ggarrange(ALD_const_td_2000,ALD_var_const_td_2000,ALD_var_AAMap_td_2000,ALD_var_HapMap_td_2000,labels = c("A","B","C","D"),
          ncol = 2, nrow = 2,common.legend = T,legend = 'bottom')
...
## Fitting True segments with cutoff for AAMap and constant 
# define cutoffs as hard or as quantiles
#lower_trunc=0.25
#upper_trunc=0.99
...
#save(True_seg_td_1,True_seg_td_200,True_seg_td_400,True_seg_td_800,True_seg_td_1000,True_seg_td_1500,True_seg_td_2000,file = "True_Segment_fit_linear_with_AAMap_constant_cutoff_quantiles.RData")
#save(True_seg_td_1,True_seg_td_200,True_seg_td_400,True_seg_td_800,True_seg_td_1000,True_seg_td_1500,True_seg_td_2000,file = "True_Segment_fit_linear_with_AAMap_constant_cutoff_quantiles_in_bp.RData")
...
Plot_LRT<- function(Data,Colour_P,main){
  ...
  Data$recomb <- factor(Data$recomb,
                      levels = c("constant","varying no correction","varying AAMap correction","varying HapMap correction"),ordered = TRUE)
  ggplot(Data,aes(x=as.factor(td),y=LRT,color=as.factor(td)))+
    geom_boxplot()+
    facet_grid(~as.factor(recomb),switch = "x")+
    geom_hline( aes(yintercept = 2 ))+
    ggtitle(main)+
    theme(
      axis.text.x=element_blank(),
...
load("True_Segment_fit_linear2.RData")
...
``` {r eval=T,fig_true_Seg_fit_visual_no_cutoff, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:fig_true_Seg_fit_visual_no_cutoff} "}
source("/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Direct_Trat_length_estimation/Fit_models.R")
## Variation in recombinations (HapMap) ##
AAMap_Map_path="/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Paper_Scripts/Simulations/Recombination_Maps/Scaled_Genetic_AAMap.txt"
HapMap_Map_path="/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Paper_Scripts/Simulations/Recombination_Maps/Scaled_HapMap.txt"
...
plot_segment_fit <- function(Path_to_Fragment_File,header,recomb_rate,Path_to_Recomb_Map,tm,td,main,cutoff=T){
  tm=tm
  td=td
  k=1/((td/(4*tm))^2)
  # Fitting functions
  ...
  if(cutoff==F){
    ...
    Fit_Results <- rbind(Fit_Results,data.frame(x=data_x$M,y=dtlomax_norm(data_x$M,scale=((EP_fit[[1]]$par[2])/EP_fit[[1]]$par[1]), shape=(EP_fit[[1]]$par[2])),fit="EP_fit"))
    ...
    Fit_Results <- rbind(Fit_Results,data.frame(x=data_x$M,y=dtlomax(data_x$M,scale=((EP_fit[[1]]$par[2])/EP_fit[[1]]$par[1]), shape=(EP_fit[[1]]$par[2]),lower_trunc,upper_trunc),fit="EP_fit"))
...
``` {r eval=T,figR2_1_LRT, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR2_1_LRT} "}
...
```{r eval=T,figR2_1_cutoff, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR2_1_cutoff} "}
#load("True_Segment_fit.RData")
#load("True_Segment_fit_linear_with_AAMap_constant_cutoff.RData")
#load("True_Segment_fit_linear_with_AAMap_constant_cutoff_quantiles.RData")
#load("True_Segment_fit_linear_with_AAMap_constant_cutoff_quantiles_in_bp.RData")
...
``` {r eval=T,fig_true_Seg_fit_visual_cutoff, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:fig_true_Seg_fit_visual_cutoff} "}
True_const_td_1 <- plot_segment_fit(Path_to_Fragment_File = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison/ALL_Simulation-merged-_Scenario_1__Archaic_Segments_run_0.bed",header = F,recomb_rate = 1.2e-8,Path_to_Recomb_Map = NULL,tm = 1500,td = 1,main = "Constant;Constant")
True_var_HapMap_td_1 <- plot_segment_fit(Path_to_Fragment_File = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map/ALL_Simulation-merged-_Scenario_1_Recomb__Archaic_Segments_run_0.bed",header = F,recomb_rate = NULL,Path_to_Recomb_Map = HapMap_Map_path,tm = 1500,td = 1,main = "HapMap;HapMap")
True_var_AAMap_td_1 <- plot_segment_fit(Path_to_Fragment_File = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map/ALL_Simulation-merged-_Scenario_1_Recomb__Archaic_Segments_run_0.bed",header = F,recomb_rate = NULL,Path_to_Recomb_Map = AAMap_Map_path,tm = 1500,td = 1,main = "HapMap;AAMap")
True_var_const_td_1 <- plot_segment_fit(Path_to_Fragment_File = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map/ALL_Simulation-merged-_Scenario_1_Recomb__Archaic_Segments_run_0.bed",header = F,recomb_rate = mean_HapMap_rr,Path_to_Recomb_Map = NULL,tm = 1500,td = 1,main = "HapMap;Constant")

True_td_1 <- ggarrange(True_const_td_1,True_var_const_td_1,True_var_AAMap_td_1,True_var_HapMap_td_1,labels = c("A","B","C","D"),
          ncol = 2, nrow = 2,common.legend = T,legend = 'bottom')
...
``` {r eval=T,figR2_1_LRT_with_cutoff, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR2_1_LRT_with_cutoff} "}
...
#load("Inferred_Segment_fit_linear_no_cutoff.RData")
# -> doesnt work so great
#load("Inferred_Segment_fit_linear_min_max_cutoff.RData")
# -> doesnt work so great
...
Inf_td_1 <- ggarrange(Inf_const_td_1,Inf_var_const_td_1,Inf_var_AAMap_td_1,Inf_var_HapMap_td_1,labels = c("A","B","C","D"),
          ncol = 2, nrow = 2,common.legend = T,legend = 'bottom')
...
Inf_td_2000 <- ggarrange(Inf_const_td_2000,Inf_var_const_td_2000,Inf_var_AAMap_td_2000,Inf_var_HapMap_td_2000,labels = c("A","B","C","D"),
          ncol = 2, nrow = 2,common.legend = T,legend = 'bottom')
...
``` {r eval=T,figR2_2_LRT, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR2_2_LRT} "}
...
```{r eval=F,figR2_2_1_NO_CUTTOFF, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR2_2_1_NO_CUTTOFF} "}
#load("Inferred_Segment_fit.RData")
#load("Inferred_Segment_fit_linear.RData")
load("Inferred_Segment_fit_linear_no_cutoff.RData")
# -> doesnt work so great
