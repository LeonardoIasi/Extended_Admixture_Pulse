...
```{r table_Supplements_SP_model_3, echo=FALSE,results='asis',message=F }
...
```{r table_Supplements_SP_model_3_predictions, echo=FALSE,results='asis' ,message=F}
...
```{r table_Supplements_EP_model_3, echo=FALSE,results='asis' ,message=F,warning=F}
...
```{r table_Supplements_EP_and_SP_model_3, echo=FALSE,results='asis',message=F ,warning=F}
...
```{r table_Supplements_EP_tm_td_and_SP_model_3, echo=FALSE,results='asis',message=F ,warning=F}
...
```{r table_Supplements_EP_model_3_predictions, echo=FALSE,results='asis',message=F,warning=F }
...
```{r table_Supplements_EP_and_SP_model_3_predictions, echo=FALSE,results='asis' ,message=F,warning=F}
...
```{r table_Supplements_EP_tm_td_and_SP_model_3_predictions, echo=FALSE,results='asis',message=F,warning=F }
...
data_x <- rbind(SP_Fit[[2]],EP_Fit[[2]],EP_Fit_fixed_td_1[[2]],EP_Fit_fixed_td_100[[2]],
...
Fit_Results <- rbind(SP_Fit[[3]],EP_Fit[[3]],EP_Fit_fixed_td_1[[3]],EP_Fit_fixed_td_100[[3]],
...
Fit_Results$fit <- factor(Fit_Results$fit,levels = c("SP_fit"  ,  "EP_fit" ,"EP_fit_1" ,"EP_fit_100","EP_fit_200","EP_fit_400","EP_fit_800"
...
P_fit_normal <- ggplot(data=Fit_Results,aes(x = x, y = y,color=fit,fill=NULL))+
  ...
  labs(y = "weighted LD")+
  scale_color_manual("Fit",
                     values = c(c(cbPalette_viridis[1:11])),
                    labels = c(c("fitted SP","fitted EP","EP td = 1"
