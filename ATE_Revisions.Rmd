...
Segments_ALD_Results_flipped <- ggarrange(Seg_ald_td_results,Seg_ald_tm_results,labels = c("A","B"),
                                   ncol = 1, nrow = 2,heights  = c(0.4,0.6),common.legend = T,legend = 'bottom')
Segments_ALD_Results_flipped
```
...
Segments_ALD_supp_flipped <- ggarrange(Seg_ald_td_supp,Seg_ald_tm_supp,labels = c("A","B"),
                                  ncol = 1, nrow = 2,heights  = c(0.4,0.6),common.legend = T,legend = 'bottom')
Segments_ALD_supp_flipped
```
...
plot_segment_fit <- function(Path_to_Fragment_File,header,recomb_rate,Path_to_Recomb_Map,tm,td,main,cutoff=T,Data,legend=F,margins=c(0.25,0.5,0,0.5)){
  ...
  P_fit <- ggplot(data=Fit_Results,aes(x = x, y = y,color=fit,fill=NULL))+
    ...
    ylim(min(data_x$dens),max(data_x$dens))+
    scale_color_manual("Fit",
                       values = c(c(cbPalette_viridis[1],cbPalette_viridis[3],cbPalette_viridis[9],cbPalette_viridis[12])),
...
AIC_comp$Data <- "ALD"
AIC_comp_results <- AIC_comp %>% filter(Name!="HapMap/Constant") %>% filter(Name!="HapMap/AAMap")
...
F_Test_comp_results <- F_Test_comp %>% filter(Name!="HapMap/Constant") %>% filter(Name!="HapMap/AAMap")

P_F_Test_results <- ggplot(F_Test_comp_results, aes(x=as.factor(Name), y=-log(F_Test_p_rounded),color=as.factor(Name))) + 
                geom_boxplot()+
                facet_grid(Data~GF_duration,switch = "x")+
...
P_F_Test_results_together <- ggplot(F_Test_comp_results, aes(x=as.factor(Name), y=(F_Test_p_rounded),color=as.factor(Name))) + 
                geom_boxplot()+
                facet_grid(Data~GF_duration,switch = "x")+
                ...
                scale_color_manual("Recombination",
                                   ...
                                   guide = guide_legend(direction = "vertical", title.position = "left",
                                                        title.theme = element_text(angle = 90,size=8), title.hjust = 0.5, title.vjust = 0.5,
...
F_Test_comp_supplements <- F_Test_comp %>% filter(Name!="Constant/Constant") %>% filter(Name!="HapMap/HapMap")
...
P_F_Test_supplements_together <- ggplot(F_Test_comp_supplements, aes(x=as.factor(Name), y=(F_Test_p_rounded),color=as.factor(Name))) + 
                geom_boxplot()+
                facet_grid(Data~GF_duration,switch = "x")+
                geom_hline( aes(yintercept = 0.05 ))+
                labs(y = "p-value")+
...
Plot.data_ALD$Name <- factor(Plot.data_ALD$Name,
                    levels = c("Constant/Constant","HapMap/Constant","HapMap/AAMap","HapMap/HapMap"),ordered = TRUE)
RSS_diff_norm <- Plot.data_ALD %>% group_by(Name) %>% group_map(~ (0-(log(.x$RSS_SP)-log(.x$RSS_EP))/sd((log(.x$RSS_SP)-log(.x$RSS_EP))) ) )
RSS_comp=data.frame(RSS_diff=log(Plot.data_ALD$RSS_SP)-log(Plot.data_ALD$RSS_EP),
...
Segment_ALD_Model_comparison_results <- ggarrange(Plot_LRT_seg_results,P_RSS_comp_results,labels = c("A","B"),
...
```{r eval=F,figResult2_2and3, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=7.5,fig.height=4,fig.cap="\\label{fig:figResult2_2and3} "}

Plot_LRT_together<- function(Data,main,recomb_levels,recomb_lables,col1,col2){
  Data$LRT <- ifelse(Data$LRT>=10,10,Data$LRT)
  Data$recomb <- factor(Data$recomb,
                      levels = recomb_levels,ordered = TRUE)
  Data$Data <- factor(Data$Data,
...
Plot_LRT_seg_results_together <- Plot_LRT_together(Segments_LRT_result,"",c("constant","varying HapMap correction"),c("Constant/Constant","HapMap/HapMap"),cbPalette_viridis[1],cbPalette_viridis[12])

Segment_ALD_Model_comparison_results_together <- ggarrange(Plot_LRT_seg_results_together,P_F_Test_results_together,
                                                  nrow=2,ncol=1,heights = c(0.63,0.37),common.legend = T,legend = 'right')
ggarrange(P_2_fit_Result,Segment_ALD_Model_comparison_results_together,labels = c("A","B"),
                                                  nrow=1,ncol=2,widths = c(0.63,0.37))

```

```{r eval=F,figResult2_3_supplements, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=4,fig.height=4,fig.cap="\\label{fig:figResult2_3_supplements} "}
...
Segment_ALD_Model_comparison_supplements <- ggarrange(Plot_LRT_seg_sup,P_RSS_comp_supplements,labels = c("A","B"),
                                                  nrow=2,ncol=1,heights = c(0.63,0.37),common.legend = T,legend = 'bottom')

Segment_ALD_Model_comparison_supplements
```

```{r eval=F,figResult2_2and3_supplement, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=7.5,fig.height=4,fig.cap="\\label{fig:figResult2_2and3_supplement} "}
...
Plot_LRT_seg_sup_together <- Plot_LRT_together(Segments_LRT_supplements,"",c("constant","varying HapMap correction"),c("HapMap/Constant","HapMap/AAMap"),cbPalette_viridis[3],cbPalette_viridis[9])

Segment_ALD_Model_comparison_supplements_together <- ggarrange(Plot_LRT_seg_sup_together,P_F_Test_supplements_together,nrow=2,ncol=1,heights = c(0.63,0.37),common.legend = T,legend = 'right')


ggarrange(P_2_fit_Supplements,Segment_ALD_Model_comparison_supplements_together,labels = c("A","B"),
                                                  nrow=1,ncol=2,widths = c(0.63,0.37))
```
...
Fig_2_Result <- ggarrange(Segment_ALD_Model_comparison_results,Segments_ALD_Results_flipped,P_2_fit_Result,
                                                  nrow=2,ncol=2,common.legend = F)

ggarrange(ggarrange(Segment_ALD_Model_comparison_results, Segments_ALD_Results_flipped, ncol = 2, labels = c("A", "B"),common.legend = T,legend = "bottom"),P_2_fit_Result, 
          nrow = 2, 
          labels = "C"                                       
          )
...
Fig_2_Supplements <- ggarrange(Segments_ALD_supp_flipped,P_2_fit_Supplements,Segment_ALD_Model_comparison_supplements,
...
ggdata_t.GF_varying_mean_GF_lomax <- melt(Plot.data_varying,measure.vars =  c('length_GF'),id.vars = c('True_mean_GF','True_GF_length','Name','Sample_Time'))
...
P_RSS_comp_50 <- ggplot(RSS_comp_50, aes(x=as.factor(Name), y=(RSS_diff_norm),color=as.factor(Name))) + 
                geom_boxplot()+
                facet_grid( Data~as.factor(Sample_Time)+as.factor(GF_duration)+as.factor(True_mean_GF),switch = "x")+
                geom_hline( aes(yintercept = 0 ))+
                labs(y = "Normalized\nlog RSS Difference ")+
                labs(x = "Admixture Duration")+
                ylim(-2,2)+
...
RSS_comp_varying=data.frame(RSS_diff=log(Plot.data_varying_complete$RSS_SP)-log(Plot.data_varying_complete$RSS_EP),
                           RSS_diff_norm= unlist(Plot.data_varying_complete),
...
RSS_comp_varying$Name <- factor(RSS_comp_varying$Name,
                    levels = c("Recent_50_constant","Recent_50_HapMap_no_correction","Recent_50_HapMap_AAMap_correction","Recent_50_HapMap_HapMap_correction"),ordered = TRUE)
...
AIC_comp_ts_50=data.frame(AIC_SP=Plot.data_50$AIC_SP,AIC_EP=Plot.data_50$AIC_EP,
                          Sample_Time=Plot.data_varying$Sample_Time,
                      GF_duration=Plot.data_50$True_GF_length,Name=Plot.data_50$Name,
                      True_mean_GF=Plot.data_50$True_tm)
AIC_comp_ts_50$AIC_SP_rounded <- ifelse(AIC_comp_ts_50$AIC_SP>=20,20,AIC_comp_ts_50$AIC_SP)
AIC_comp_ts_50$Name <- factor(AIC_comp_ts_50$Name,
                    levels = c("Recent_50_constant","Recent_50_HapMap_no_correction","Recent_50_HapMap_AAMap_correction","Recent_50_HapMap_HapMap_correction"),ordered = TRUE)
AIC_comp_ts_50$Data <- "ALD"

AIC_comp_ts_varying=data.frame(AIC_SP=Plot.data_varying$AIC_SP,AIC_EP=Plot.data_varying$AIC_EP,
                      Sample_Time=Plot.data_varying$Sample_Time,GF_duration=Plot.data_50$True_GF_length,Name=Plot.data_varying$Name,
                      True_mean_GF=Plot.data_50$True_tm)
AIC_comp_ts_varying$AIC_SP_rounded <- ifelse(AIC_comp_ts_varying$AIC_SP>=20,20,AIC_comp_ts_varying$AIC_SP)
AIC_comp_ts_varying$Name <- factor(AIC_comp_ts_varying$Name,
                    levels = c("Recent_50_constant","Recent_50_HapMap_no_correction","Recent_50_HapMap_AAMap_correction","Recent_50_HapMap_HapMap_correction"),ordered = TRUE)
AIC_comp_ts_varying$Data <- "ALD"

P_AIC_50 <- ggplot(AIC_comp_ts_50, aes(x=as.factor(Name), y=AIC_SP_rounded,color=as.factor(Name))) + 
                geom_boxplot()+
                facet_grid( Data~as.factor(Sample_Time)+as.factor(GF_duration)+as.factor(True_mean_GF),switch = "x")+
                labs(y = "AIC")+
                labs(x = "")+
...
P_AIC_varying <- ggplot(AIC_comp_ts_varying, aes(x=as.factor(Name), y=AIC_SP_rounded,color=as.factor(Name))) + 
                geom_boxplot()+
                facet_grid( Data~as.factor(Sample_Time)+as.factor(GF_duration)+as.factor(True_mean_GF),switch = "x")+
                labs(y = "AIC")+
                labs(x = "")+
...
F_Test_comp_ts_50=data.frame(F_Test_p=Plot.data_50$F_Test,
                      Sample_Time=Plot.data_50$Sample_Time,GF_duration=Plot.data_50$True_GF_length,Name=Plot.data_50$Name,
                      True_mean_GF=Plot.data_50$True_tm)
#F_Test_comp$F_Test_p_rounded <- ifelse(F_Test_comp$F_Test_p>=0.1,0.1,F_Test_comp$F_Test_p)
F_Test_comp_ts_50$F_Test_p_rounded <- F_Test_comp_ts_50$F_Test_p
F_Test_comp_ts_50$Name <- factor(F_Test_comp_ts_50$Name,
                    levels = c("Recent_50_constant","Recent_50_HapMap_no_correction","Recent_50_HapMap_AAMap_correction","Recent_50_HapMap_HapMap_correction"),ordered = TRUE)
F_Test_comp_ts_50$Data <- "ALD"

F_Test_comp_ts_varying=data.frame(F_Test_p=Plot.data_varying$F_Test,
                      Sample_Time=Plot.data_varying$Sample_Time,GF_duration=Plot.data_varying$True_GF_length,Name=Plot.data_varying$Name,
                      True_mean_GF=Plot.data_varying$True_tm)
#F_Test_comp$F_Test_p_rounded <- ifelse(F_Test_comp$F_Test_p>=0.1,0.1,F_Test_comp$F_Test_p)
F_Test_comp_ts_varying$F_Test_p_rounded <- F_Test_comp_ts_varying$F_Test_p
F_Test_comp_ts_varying$Name <- factor(F_Test_comp_ts_varying$Name,
                                        levels = c("Recent_50_constant","Recent_50_HapMap_no_correction","Recent_50_HapMap_AAMap_correction","Recent_50_HapMap_HapMap_correction"),ordered = TRUE)
F_Test_comp_ts_varying$Data <- "ALD"

P_F_Test_50 <- ggplot(F_Test_comp_ts_50, aes(x=as.factor(Name), y=(F_Test_p_rounded),color=as.factor(Name))) + 
                geom_boxplot()+
                  facet_grid( Data~as.factor(Sample_Time)+as.factor(GF_duration)+as.factor(True_mean_GF),switch = "x")+
                geom_hline( aes(yintercept = 0.05 ))+
                labs(y = "p-value")+
...
P_F_Test_varying <- ggplot(F_Test_comp_ts_varying, aes(x=as.factor(Name), y=(F_Test_p_rounded),color=as.factor(Name))) + 
                geom_boxplot()+
                facet_grid( Data~as.factor(Sample_Time)+as.factor(GF_duration)+as.factor(True_mean_GF),switch = "x")+
                geom_hline( aes(yintercept = 0.05 ))+
                labs(y = "p-value")+
