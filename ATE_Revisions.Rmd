...
Plot_LRT_together<- function(Data,Colour_P,main,recomb_levels,recomb_lables){
  Data$LRT <- ifelse(Data$LRT>=10,10,Data$LRT)
  Data$recomb <- factor(Data$recomb,
                      levels = recomb_levels,ordered = TRUE)
  Data$Data <- factor(Data$Data,
...
Plot_LRT_seg_results_together <- Plot_LRT_together(Segments_LRT_result,cbPalette_viridis,"",c("constant","varying HapMap correction"),c("Constant;Constant","HapMap;HapMap"))
...
Plot_LRT_seg_sup_together <- Plot_LRT_together(Segments_LRT_supplements,cbPalette_viridis,"",c("varying no correction","varying AAMap correction"),c("HapMap;Constant","HapMap;AAMap"))
