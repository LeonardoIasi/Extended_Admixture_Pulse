...
## Figure 3.1 and corresponding supplements
...
```{r figResult3_1,message=FALSE, echo=FALSE,warning=FALSE,fig1.pos="H",fig.width=9,fig.height=9,fig.cap="\\label{fig:figResult3_1} Segments, ALD constant;constant, HapMap;HapMap"}
# Segments True
...
Plot_tm <- function(ggdata,cbPalette_viridis,main,rr_1,rr_2){
  ...
  ggplot(data = ggdata, aes(y=(Data),x=as.numeric(as.character(tm_est)),colour=(rr))) +
    ...
    scale_x_continuous(breaks = seq(0, 1000, by = 500))+
    scale_color_manual("Simulations",
                       values = c(cbPalette_viridis[7],cbPalette_viridis[1]),
                       labels = c(rr_2,rr_1),
                       guide = guide_legend(reverse=TRUE))
...
```{r figResult3_1_Supplement,message=FALSE, echo=FALSE,warning=FALSE,fig1.pos="H",fig.width=9,fig.height=9,fig.cap="\\label{fig:figResult3_1_Supplement} Segments, ALD HapMap;constant, HapMap;AAMap"}
...
## Figure 3.2 and corresponding supplements
...
plot_segment_fit <- function(Path_to_Fragment_File,header,recomb_rate,Path_to_Recomb_Map,tm,td,main,cutoff=T,Data,legend=F){
  tm=tm
  td=td
  k=1/((td/(4*tm))^2)
  # Fitting functions  
...
plot_ALD_fit <- function(input,lval=0.05,hval=0.8,tm,td,use_log=F,main,legend=F){
  tm=tm
  td=td
  k=1/((td/(4*tm))^2)
  # Fitting functions
...
ALD_const_td_1 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_ALD/Raw_ALDER_output-_Scenario_1_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccNo_correction.txt",tm = 1500,td = 1,use_log=F,main = "ALD")
ALD_var_const_td_1 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_1_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccNo_correction.txt",tm = 1500,td = 1,use_log=T,main = "ALD")
ALD_var_AAMap_td_1 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_1_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccAAMap_correction.txt",tm = 1500,td = 1,use_log=T,main = "",legend=F)
ALD_var_HapMap_td_1 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_1_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccHapMap_correction.txt",tm = 1500,td = 1,use_log=F,main = "",legend=F)



ALD_const_td_2000 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_ALD/Raw_ALDER_output-_Scenario_7_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccNo_correction.txt",tm = 1500,td = 2000,use_log=F,main = "ALD")
ALD_var_const_td_2000 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_7_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccNo_correction.txt",tm = 1500,td = 2000,use_log=T,main = "ALD")
ALD_var_AAMap_td_2000 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_7_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccAAMap_correction.txt",tm = 1500,td = 2000,use_log=F,main = "ALD:\nHapMap;AAMap",legend=T)
ALD_var_HapMap_td_2000 <- plot_ALD_fit(input = "/home/leonardo_iasi/Desktop/Neandertal_Human_Introgression_Project/Paper/Segment_ALD_comparison_recombination_map_ALD/Raw_ALDER_output-_Scenario_7_Recomb_-run0-GF_Model_IV-ascertainmentI-downsampled100-ReccHapMap_correction.txt",tm = 1500,td = 2000,use_log=F,main = "",legend=T)


```

```{r eval=T,figResult3_2, message=FALSE, echo=FALSE,warning=FALSE,figR3_3.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figResult3_2} Fit to data Segments, ALD constant;constant, HapMap;HapMap"}
...
```{r eval=T,figResult3_2_Supplements, message=FALSE, echo=FALSE,warning=FALSE,figR3_3.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figResult3_2_Supplements} Fit to data Segments, ALD HapMap;constant, HapMap;AAMap"}
...
## Figure 3.3 and corresponding supplements
...
P_AIC_results <- ggplot(AIC_comp_results, aes(x=as.factor(Name), y=AIC_SP_rounded,color=as.factor(Name))) + 
                geom_boxplot()+
                facet_grid(~GF_duration,switch = "x")+
                labs(y = "AIC")+
                labs(x = "")+
                theme(
                  axis.ticks.y=element_blank(),
...
```{r eval=T,figR3_3, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR3_3} "}
...
Plot_LRT<- function(Data,Colour_P,main,recomb_levels,recomb_lables){
  ...
  ggplot(Data,aes(x=as.factor(recomb),y=LRT,color=as.factor(recomb)))+
    geom_boxplot()+
    facet_grid(~as.factor(td),switch = "x")+
...
Plot_LRT_true_results <- Plot_LRT(True_segments_results,cbPalette_viridis,"",c("constant","varying HapMap correction"),c("Constant;Constant","HapMap;HapMap"))
Plot_LRT_inf_results <- Plot_LRT(Inferred_segments_results,cbPalette_viridis,"",c("constant","varying HapMap correction"),c("Constant;Constant","HapMap;HapMap"))

Segment_ALD_Model_comparison_results <- ggarrange(Plot_LRT_true_results,Plot_LRT_inf_results,P_F_Test_results,labels = c("A","B","C"),
                                                  nrow=3,ncol=1,common.legend = T,legend = 'bottom')

```

```{r eval=T,figR3_3_supplements, message=FALSE, echo=FALSE,warning=FALSE,fig2.pos="H",fig.width=9,fig.height=10,fig.cap="\\label{fig:figR3_3_supplements} "}
...
Plot_LRT_true_supplements <- Plot_LRT(True_segments_supplements,cbPalette_viridis,"",c("varying no correction","varying AAMap correction"),c("HapMap;Constant","HapMap;AAMap"))
Plot_LRT_inf_supplements <- Plot_LRT(Inferred_segments_supplements,cbPalette_viridis,"",c("varying no correction","varying AAMap correction"),c("HapMap;Constant","HapMap;AAMap"))

Segment_ALD_Model_comparison_results <- ggarrange(Plot_LRT_true_supplements,Plot_LRT_inf_supplements,P_F_Test_supplements,labels = c("A","B","C"),
                                                  nrow=3,ncol=1,common.legend = T,legend = 'bottom')
```
