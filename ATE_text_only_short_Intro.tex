...
either used the African-American-Map (\cite{hinch_landscape_2011})
...
genetic distances. For simulating the Icelandic fragment we used 150 Mb of chromosome 1 from the decode map \cite{} \(0.914 \, \frac{cM}{Mb}\).
