...
varying recombination (-1.76 - -1.7 95 \% CI) and the smallest
differences between a pulse and continuous gene flow model (-0.34 -
-0.28 95 \% CI). Most accurate estimates are achieved using the LES
