...
\begin{titlepage}
    ...
    \end{flushright}
        ...
        \vspace*{1cm}
            ...
            \Huge
        \vspace*{1cm}
            \centering\textf{An extended admixture pulse model reveals the limits to the dating of Human-Neandertal introgression}
        
       \vspace{1.0cm}
        \large
        \text{Iasi, Leonardo N. M. \textsuperscript{1,2} and Peter , Benjamin M. \textsuperscript{1,3}} \\ 
