...
\subsubsection{Parameter estimation under extended pulse model}
...
% facet_wrap(~ tm + td, labeller="label_both")
...
. is substantially less resilient to deviations in the recombination rate. 
Estimates for simulation under a recombination map only
