...
The model has some general assumptions beside the one-generation pulse such as tracts are rare and inbreeding is not significant. The introgressed segments act neutral and the recombination clock is constant over time and populations. We will keep these assumptions and focus on the technical ones. It is usually assumed that the demography is known or its effects negligible, the recombination map known or recombination is constant. Beside that is is assumed that the ascertainment scheme represent the variation in the true introgressing archaic population well.
